  ...
  const root=el('main', { class:'screen day-screen' },
    ...
    el('section', { class:'toolbar day-toolbar' },
      el('div', { class:'toolbar-left' },
        iconButton(state.refData,'Btn_Nav_Day','Calendar',()=>{}),
    ...
    bottomNav(state.refData, { homeLabel:'Home', day:goMain, trip:()=>pushRoute('trip'), sheet:()=>window.open(sheetUrl(),'_blank','noopener'), sync:syncAll, more:()=>setState({ modal:'more' }) }, 'day')
  );
